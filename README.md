...
2. **Run the Visualization**:
   - Execute the following command in your terminal:
     ...
     python plot.py
     ```
notice: we only labeled the shuttle position for hit/drop samples that are used in this study. To obtain shuttle position at each frame, please use the tracking algorithm or labeling tool in [TrackNet]https://nol.cs.nctu.edu.tw:234/open-source/TrackNetv2/[TrackNetV2](https://nol.cs.nctu.edu.tw:234/open-source/TrackNetv2) to 
## Dataset Details
